...
export default function MakeOrder({ item, statusOrder, id }) {
            ...
            <View style={styles.container}>
                <View style={styles.display}>
                    ...
                    <View style={styles.text}>
                        ...
                        {status === 'completed' ?  <Button onPress={checkDone} icon={<FontAwesome5 name="check" size={10} color="#FFF" style={styles.iconadd} />} buttonStyle={{...styles.btnadd,backgroundColor:'#03a9f4'}} /> : same ? <Button onPress={checkDone} icon={<FontAwesome5 name="check" size={10} color="#FFF" style={styles.iconadd} />} buttonStyle={styles.btnadd} /> : 
